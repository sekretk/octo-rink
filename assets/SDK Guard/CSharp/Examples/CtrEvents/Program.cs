    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                hr = ZGIntf.ZG_Cvt_Open(ref hCvt1, ref rOp, rInfo);
                if (hr < 0)
                {
                ...
                hr = ZGIntf.ZG_Ctr_Open(ref m_hCtr, hCvt1, CtrAddr, 0, ref rCtrInfo);
                if (hr < 0)
                {
            ...
            finally
            {
                ...
                if (hCvt1 != IntPtr.Zero)
                    ZGIntf.ZG_CloseHandle(hCvt1);
                ZGIntf.ZG_Finalyze();
            }
        }
    }
