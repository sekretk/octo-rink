...
namespace ZGuard
{
    ...
    class ZGIntf
    {
        ...
        public const int ZG_SDK_VER_MINOR = 33;
        #endregion
        ...
        // Преобразовать номер ключа EmMarine в строку
        public static string EmMarineToStr(Byte[] aNum)
        {
            return $"{aNum[3]:D3}{aNum[1] + (aNum[2] << 8):D5}";
        }
    }
}
