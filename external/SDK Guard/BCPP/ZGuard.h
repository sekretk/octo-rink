...
#define ZG_FR_SRCF_INPUT_F		0x01	// Разрешен пожарный режим по входу FIRE
#define ZG_FR_SRCF_TEMP			0x02	// Разрешен пожарный режим по превышению температуры
...
#define ZG_SR_SRCF_INPUT_F		0x01	// Разрешена тревога по входу FIRE
#define ZG_SR_SRCF_TAMPERE		0x02	// Разрешена тревога по тамперу
#define ZG_SR_SRCF_DOOR			0x04	// Разрешена тревога по датчику двери
...
typedef HRESULT ZG_STATUS DEPRECATED_ATTR;	// результат выполнения функции DLL
