...
#define ZP_IF_NO_MSG_LOOP			0x01	// Приложение не имеет цикла обработки сообщений (Console or Service)
#define ZP_IF_LOG					0x02	// Записывать лог
...
//#pragma deprecated(ZP_EnumSerialPorts)
//#endif
DEPRECATED_FN
