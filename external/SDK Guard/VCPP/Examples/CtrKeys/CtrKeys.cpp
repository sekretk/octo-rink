...
void DoClearKey()
{
	...
	if (!CheckZGError(ZG_Ctr_ClearKeys(g_hCtr, nKeyIdx, 1, NULL, NULL, nBankN), _T("ZG_Ctr_ClearKeys")))
		return;
	_tprintf(TEXT("Done.\n"));
}
...
void DoClearAllKeys()
{
	...
	if (!CheckZGError(ZG_Ctr_ClearKeys(g_hCtr, 0, nTop, NULL, NULL, nBankN), _T("ZG_Ctr_ClearKeys")))
		return;
	_tprintf(TEXT("Done.\n"));
}
