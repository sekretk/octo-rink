...
procedure ZPInit();{$IFDEF HAS_INLINE}inline;{$ENDIF}
...
function TZPort.GetConnectionStatus(): TZp_Connection_Status;
begin
  ASSERT(Opened);
  CheckZPError(ZP_Port_GetConnectionStatus(m_hHandle, Result));
end;
...
begin
  ...
  CheckZPError(ZP_Initialize(nil, ZP_IF_LOG));
end;
